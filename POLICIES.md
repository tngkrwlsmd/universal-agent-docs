...
<!-- generated-policy-reference:start -->
> 이 블록은 `POLICY_CONTRACT.json`에서 자동 생성한다. 직접 수정하지 말고 `python scripts/generate_policy_reference.py`로 갱신한다.
...
<!-- generated-policy-reference:end -->
